...
// Deliberation Section Animation
gsap.from("#deliberation h2", {
  scrollTrigger: {
...
gsap.utils.toArray(".deliberation-card").forEach((card, i) => {
  gsap.from(card, {
    scrollTrigger: {
      trigger: card,
      start: "top 85%",
...
${data.message}
        ...
        const mailtoLink = `mailto:aneeshprabu2510@gmail.com?subject=${emailSubject}&body=${emailBody}`;
